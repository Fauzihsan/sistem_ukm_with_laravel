...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $menungguBlm = Proposal::all()->where("validated_blm",0)->count();
        $disetujuiBlm = Proposal::all()->where("validated_blm",1)->count();
        $menungguPembimbing = Proposal::all()->where("validated_pembimbing",0)->count();
        $disetujuiPembimbing = Proposal::all()->where("validated_pembimbing",1)->count();
        $menungguWd3 = Proposal::all()->where("validated_wd3",0)->count();
        $disetujuiWd3 = Proposal::all()->where("validated_wd3",1)->count();
        $menungguDekan = Proposal::all()->where("validated_dekan",0)->count();
